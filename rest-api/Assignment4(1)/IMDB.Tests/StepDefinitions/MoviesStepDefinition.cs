...
{
    [Scope(Feature = "Movies")]
    [Binding]
    public class MovieStepDefinitions : BaseSteps
    {
        public MovieStepDefinitions(CustomWebApplicationFactory factory) : base(factory.WithWebHostBuilder(builder =>
        {
